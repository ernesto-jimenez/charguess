...
* libcharguess-ruby: http://raa.ruby-lang.org/project/charguess/}
  ...
  s.files = ["Gemfile", "Gemfile.lock", "History.txt", "Manifest.txt", "PostInstall.txt", "README.rdoc", "Rakefile", "ext/charguess/charguess.c", "ext/charguess/extconf.rb", "ext/libcharguess/cpp/AUTHORS", "ext/libcharguess/cpp/Big5Freq.tab", "ext/libcharguess/cpp/COPYING", "ext/libcharguess/cpp/COPYRIGHT", "ext/libcharguess/cpp/ChangeLog", "ext/libcharguess/cpp/EUCJPProber.cpp", "ext/libcharguess/cpp/EUCJPProber.h", "ext/libcharguess/cpp/EUCKRFreq.tab", "ext/libcharguess/cpp/EUCKRProber.cpp", "ext/libcharguess/cpp/EUCKRProber.h", "ext/libcharguess/cpp/EUCTWFreq.tab", "ext/libcharguess/cpp/EUCTWProber.cpp", "ext/libcharguess/cpp/EUCTWProber.h", "ext/libcharguess/cpp/EscCharsetProber.cpp", "ext/libcharguess/cpp/EscCharsetProber.h", "ext/libcharguess/cpp/EscSM.cpp", "ext/libcharguess/cpp/GB2312Freq.tab", "ext/libcharguess/cpp/GB2312Prober.cpp", "ext/libcharguess/cpp/GB2312Prober.h", "ext/libcharguess/cpp/INSTALL", "ext/libcharguess/cpp/JISFreq.tab", "ext/libcharguess/cpp/LICENSE", "ext/libcharguess/cpp/LangBulgarianModel.cpp", "ext/libcharguess/cpp/LangCyrillicModel.cpp", "ext/libcharguess/cpp/LangGreekModel.cpp", "ext/libcharguess/cpp/LangHungarianModel.cpp", "ext/libcharguess/cpp/LangThaiModel.cpp", "ext/libcharguess/cpp/Latin1Prober.cpp", "ext/libcharguess/cpp/Latin1Prober.h", "ext/libcharguess/cpp/MBCSGroupProber.cpp", "ext/libcharguess/cpp/MBCSGroupProber.h", "ext/libcharguess/cpp/MBCSSM.cpp", "ext/libcharguess/cpp/Makefile.am", "ext/libcharguess/cpp/Makefile.in", "ext/libcharguess/cpp/NEWS", "ext/libcharguess/cpp/README", "ext/libcharguess/cpp/SBCSGroupProber.cpp", "ext/libcharguess/cpp/SBCSGroupProber.h", "ext/libcharguess/cpp/SBCharsetProber.cpp", "ext/libcharguess/cpp/SBCharsetProber.h", "ext/libcharguess/cpp/SJISProber.cpp", "ext/libcharguess/cpp/SJISProber.h", "ext/libcharguess/cpp/UTF8Prober.cpp", "ext/libcharguess/cpp/UTF8Prober.h", "ext/libcharguess/cpp/aclocal.m4", "ext/libcharguess/cpp/autogen.sh", "ext/libcharguess/cpp/big5Prober.cpp", "ext/libcharguess/cpp/big5Prober.h", "ext/libcharguess/cpp/charDistribution.cpp", "ext/libcharguess/cpp/charDistribution.h", "ext/libcharguess/cpp/charguess.cpp", "ext/libcharguess/cpp/charguess.h", "ext/libcharguess/cpp/charsetProber.h", "ext/libcharguess/cpp/codingStateMachine.h", "ext/libcharguess/cpp/config.h.in", "ext/libcharguess/cpp/configure", "ext/libcharguess/cpp/configure.in", "ext/libcharguess/cpp/depcomp", "ext/libcharguess/cpp/fix_copyright", "ext/libcharguess/cpp/install-sh", "ext/libcharguess/cpp/jpCntx.cpp", "ext/libcharguess/cpp/jpCntx.h", "ext/libcharguess/cpp/missing", "ext/libcharguess/cpp/mkinstalldirs", "ext/libcharguess/cpp/pkgInt.h", "ext/libcharguess/cpp/stamp-h1", "ext/libcharguess/cpp/test/test.cpp", "ext/libcharguess/cpp/types.h", "ext/libcharguess/cpp/universal.cpp", "ext/libcharguess/cpp/universal.h", "script/console", "script/destroy", "script/generate", "tasks/extconf.rake", "tasks/extconf/charguess.rake", "test/test_charguess.rb", "test/test_charguess_extn.rb", "test/test_helper.rb", ".gemtest"]
